        ...
        if i in indexes:
            ...
            if classIds[i]==0: #bike
                ...
                if y_h>0 and x_h>0:
                    ...
                    if c==1:
                        count = count + 1
                        os.chdir("/Users/Varun/Downloads/Helmet and Number Plate Detection and Recognition/photoswithnohelmet")
                        cv2.imwrite("noHelmet" + str(count) + ".jpg" , img[y:y+h,x:x+w])
                        os.chdir("/Users/Varun/Downloads/Helmet and Number Plate Detection and Recognition")
